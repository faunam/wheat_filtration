...
def make_topic_model(tokenized_corpus: str, n_topics: int, **kwargs):  # **kwargs?
    ...
    Arguments:
        ...
        (above from gensim docs)
    Returns:
        topic_model (LdaMallet): [list attributes]
    Raises:
        Exception: Please enter the path to your Mallet directory in the MALLET_PATH variable at the top of mallet.py
    """
